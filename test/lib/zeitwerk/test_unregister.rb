...
class TestUnregister < LoaderTest
  test "unregister removes the loader from internal state" do
    ...
    registry.gem_loaders_by_entry_point["dummy1"] = loader1
    ...
    registry.gem_loaders_by_entry_point["dummy2"] = loader2
    ...
    assert !registry.gem_loaders_by_entry_point.values.include?(loader1)
    ...
    assert registry.gem_loaders_by_entry_point.values.include?(loader2)
